...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_notification__ = __webpack_require__(119);
...
var customPlugin = {
    install: function install(Vue, options) {
        ...
        Vue.prototype.selectizeDbData = function (data) {
...
window.Vue.filter('formatDate', function (value) {
    if (value) {
        return __WEBPACK_IMPORTED_MODULE_2_moment___default()(String(value)).format('DD-MM-YYYY HH:mm:ss');
    }
});

window.Vue.use(__WEBPACK_IMPORTED_MODULE_1_vue_notification___default.a);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rich_vendors_app__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rich_pages_ExchangeRateListing__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rich_pages_ExchangeRateListing___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rich_pages_ExchangeRateListing__);
...
new Vue({
    ...
    components: {
        ExchangeRateListing: __WEBPACK_IMPORTED_MODULE_1_rich_pages_ExchangeRateListing___default.a
    }
});
...
Component.options.__file = "/Users/SarapMax/code/rich-cnm/resources/assets/js/pages/ExchangeRateListing.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ExchangeRateListing.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-402153c2", Component.options)
  } else {
    hotAPI.reload("data-v-402153c2", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rich_vendors_axios__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rich_components_form_Form__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rich_components_form_FormGroup__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rich_components_form_FormGroup___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rich_components_form_FormGroup__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_notification__ = __webpack_require__(119);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            currency: {},
            currency_id: null,
            form: new __WEBPACK_IMPORTED_MODULE_1_rich_components_form_Form__["a" /* default */]({
                name: '',
                unit: '',
                country_id: '',
                banknotes: [],
    ...
    components: {
        FormGroup: __WEBPACK_IMPORTED_MODULE_2_rich_components_form_FormGroup___default.a
    },
    ...
    created: function created() {
        ...
        Echo.channel('currencyChangingChannel').listen('CurrencyEvent', function (e) {
            _this.getCurrencyWithBanknotes();
            _this.getCurrencyLastUpdated();
        });
    },


    methods: {
        showAddCurrency: function showAddCurrency() {
            this.form.reset();
        ...
        manageCurrency: function manageCurrency() {
            var _this2 = this;

            var postCurrencyUrl = void 0;
            ...
            this.form.post(postCurrencyUrl).then(function (data) {
                ...
                _this2.getCurrencyWithBanknotes();
                _this2.getCurrencyLastUpdated();
        ...
        deleteCurrency: function deleteCurrency() {
            ...
            if (confirm('Are you sure to delete this?')) {
                this.form.post('admin/currency/' + this.currency_id + '/delete').then(function (data) {
                    $('#currencyModal').modal('hide');
                    ...
                    _this3.getCurrencyWithBanknotes();
                });
            }
        },
        getCurrencyWithBanknotes: function getCurrencyWithBanknotes() {
            var _this4 = this;

            axios.get('currency').then(function (_ref) {
                var data = _ref.data;

                _this4.currency = data;
            });
        },
        showUpdateCurrency: function showUpdateCurrency(currency_id) {
            var _this5 = this;
            ...
            axios.get('admin/currency/' + currency_id).then(function (_ref2) {
                var data = _ref2.data;

                _this5.form.country_id = data.country_id;
                _this5.form.name = data.name;
                _this5.form.unit = data.unit;

                _this5.form.banknotes = data.banknotes;

                _this5.showCurrencyModal();
            });
        },
        addBanknote: function addBanknote() {
        ...
        removeBanknote: function removeBanknote(index, banknote_id) {
            var _this6 = this;

            if (this.form.isUpdate) {
                if (confirm('Are you sure to delete this?')) {
                    axios.post('admin/banknote/' + banknote_id + '/delete').then(function (data) {
                        _this6.$notify({
                            title: 'Success',
                        ...
                        _this6.getCurrencyWithBanknotes();
                    });
        ...
        getAllCountries: function getAllCountries() {
            ...
            axios.get('admin/countries').then(function (_ref3) {
                ...
                _this7.countries = _this7.selectizeDbData(data);
            });
        },
        getCurrencyLastUpdated: function getCurrencyLastUpdated() {
            var _this8 = this;

            axios.get('currency-last-updated').then(function (_ref4) {
                var data = _ref4.data;

                _this8.currencyLastUpdated = data.updated_at;
            });
        }
    }
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rich_vendors_axios__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rich_components_form_Errors__ = __webpack_require__(156);
...
var Form = function () {
    ...
    function Form(data) {
        ...
        this.errors = new __WEBPACK_IMPORTED_MODULE_1_rich_components_form_Errors__["a" /* default */]();
    }
    ...
    _createClass(Form, [{
        ...
        value: function get(url) {
            ...
            return new Promise(function (resolve, reject) {
                axios.get(url, { params: _this.data() }).then(function (response) {
...
Component.options.__file = "/Users/SarapMax/code/rich-cnm/resources/assets/js/components/form/FormGroup.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3a10cb56", Component.options)
  } else {
    hotAPI.reload("data-v-3a10cb56", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" " + _vm._s(_vm.text))])])] : (_vm.inputType === 'select') ? [_c('label', {
    staticClass: "control-label",
    attrs: {
      "for": _vm.fieldName
    }
  }, [_vm._v(_vm._s(_vm.text))]), _vm._v(" "), _c('select', {
  ...
  })], 2)] : (_vm.inputType === 'textarea') ? [_c('label', {
    staticClass: "control-label",
    attrs: {
      "for": _vm.fieldName
    }
  }, [_vm._v(_vm._s(_vm.text))]), _vm._v(" "), _c('textarea', {
    staticClass: "form-control",
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.text))]), _vm._v(" "), (_vm.inputType === 'email') ? _c('input', {
    staticClass: "form-control",
    attrs: {
      "id": _vm.fieldName,
  ...
  }) : _vm._e(), _vm._v(" "), (_vm.inputType === 'password') ? _c('input', {
    staticClass: "form-control",
    attrs: {
      "id": _vm.fieldName,
      "autofocus": _vm.autofocus,
  ...
  }) : _vm._e(), _vm._v(" "), (_vm.inputType === 'number') ? _c('input', {
    staticClass: "form-control",
    attrs: {
      "id": _vm.fieldName,
      "autofocus": _vm.autofocus,
  ...
  }) : _vm._e(), _vm._v(" "), (_vm.inputType === 'text') ? _c('input', {
    staticClass: "form-control",
    attrs: {
      "id": _vm.fieldName,
      "autofocus": _vm.autofocus,
    ...
    staticClass: "help-block input-error"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3a10cb56", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "row"
  }, [_c('notifications'), _vm._v(" "), _c('div', {
    staticClass: "last-updated col-md-12"
  }, [_c('h4', [_c('i', {
    staticClass: "fa fa-refresh"
  }), _vm._v(" Last updated: " + _vm._s(_vm._f("formatDate")(_vm.currencyLastUpdated)))])]), _vm._v(" "), _c('div', {
    ...
    staticClass: "table",
    attrs: {
      "id": "currency-exchange-rate-table"
    }
  }, [_vm._m(0), _vm._v(" "), _vm._l((_vm.currency), function(c) {
    return _c('tbody', [_c('tr', {
      on: {
        "click": function($event) {
          _vm.showUpdateCurrency(c.id)
        }
      }
    }, [_c('th', [_c('ul', {
    ...
    on: {
      "click": _vm.showAddCurrency
    }
  }, [_c('i', {
    staticClass: "fa fa-plus"
  }), _vm._v(" Add Currency")]) : _vm._e()])])]), _vm._v(" "), _c('div', {
    ...
    attrs: {
      "field-name": "country",
      "error": _vm.form.errors.get('country_id'),
      "text": "Country",
      "input-type": "select",
    ...
    attrs: {
      "field-name": "unit",
      "error": _vm.form.errors.get('unit'),
      "text": "Currency Unit",
      "input-type": "text",
      "placeholder": "$, €"
    },
    ...
    on: {
      "click": _vm.addBanknote
    }
  }, [_c('i', {
    staticClass: "fa fa-plus"
  }), _vm._v(" Add banknotes")])])]), _vm._v(" "), _c('br'), _vm._v(" "), _vm._l((_vm.form.banknotes), function(banknote, index) {
    return _c('div', {
      staticClass: "row banknote-form"
    }, [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (banknote.id),
        expression: "banknote.id"
      }],
      attrs: {
        "type": "hidden"
      },
      ...
      on: {
        "input": function($event) {
          ...
          banknote.id = $event.target.value
        }
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "col-md-4"
      ...
      attrs: {
        ...
        "error": _vm.form.errors.get(("banknotes." + index + ".name")),
        "text": "Banknote",
        "input-type": "text"
      },
      model: {
      ...
      attrs: {
        ...
        "error": _vm.form.errors.get(("banknotes." + index + ".buying")),
        "text": "Buying",
        "input-type": "text"
      },
      model: {
        value: (banknote.buying),
        callback: function($$v) {
          banknote.buying = $$v
        },
        expression: "banknote.buying"
      }
    })], 1), _vm._v(" "), _c('div', {
      staticClass: "col-md-3"
    }, [_c('form-group', {
      attrs: {
        ...
        "error": _vm.form.errors.get(("banknotes." + index + ".selling")),
        "text": "Selling",
        "input-type": "text"
      },
      model: {
        value: (banknote.selling),
        callback: function($$v) {
          banknote.selling = $$v
        },
        expression: "banknote.selling"
      }
    })], 1), _vm._v(" "), _c('div', {
      staticClass: "col-md-2"
    }, [_c('label', {
      staticClass: "control-label"
    }, [_vm._v("Remove")]), _vm._v(" "), _c('div', [_c('button', {
      ...
      on: {
        "click": function($event) {
          _vm.removeBanknote(index, banknote.id)
        }
      }
    }, [_c('i', {
  ...
  }, [_vm._v("Save changes")]), _vm._v(" "), (_vm.form.isUpdate) ? _c('button', {
    staticClass: "btn btn-danger",
    attrs: {
      "type": "button"
    },
    on: {
      "click": _vm.deleteCurrency
    }
  ...
  }, [_vm._v("Manage Currency")])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-402153c2", module.exports)
  }
}
